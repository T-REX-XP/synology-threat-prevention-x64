...
MIRROR_CONF = os.path.join(PKGETC, "mirror.conf")
ACCEL_CONF = os.path.join(PKGETC, "accel.conf")
...
PKG_SHARES = os.environ.get("TPS_PKGSHARES", "/var/packages/ThreatPrevention/shares")
